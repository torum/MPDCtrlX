    ...
    */
    ...
    private async void MpdIdle()
    {
        ...
        catch (System.IO.IOException e)
        {
            ...
            {
                // no problem
                Debug.WriteLine("System.IO.IOException @MpdIdle -> Null return due to ConnectionStatus.Disconnecting, now exiting.");
            }
            else
            {
    ...
    private async Task<CommandResult> MpdCommandSendCommand(string cmd)
    {
        ...
        {
            ret.IsSuccess = false;
            Debug.WriteLine("@MpdCommandSendCommand: (_cts is null)");
            return ret;
        }
