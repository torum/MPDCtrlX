...
public class MenuTreeBuilder : NodeTree
{
    ...
    public MenuTreeBuilder(string name) : base(name)
    {
        ...
        NodeMenuLibrary library = new(MPDCtrlX.Properties.Resources.MenuTreeItem_Library)
        {
            Selected = false,
            Expanded = false,
        ...
        NodeMenuFiles files = new(MPDCtrlX.Properties.Resources.MenuTreeItem_Files)
        {
            Selected = false,
            Expanded = false,
